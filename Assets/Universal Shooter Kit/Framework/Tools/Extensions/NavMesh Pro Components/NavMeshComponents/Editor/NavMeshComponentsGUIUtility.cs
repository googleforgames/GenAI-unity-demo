...
namespace UnityEditor.AI
{
    public static class NavMeshComponentsGUIUtility
    {
        public static void AreaPopup(string labelName, SerializedProperty areaProperty)
        {
            ...
            GUIContent[] areaNamesGUIContent = new GUIContent[areaNames.Length];
            ...
            for (var i = 0; i < areaNames.Length; i++)
            {
                ...
                areaNamesGUIContent[i] = new GUIContent(areaNames[i], "");
            }
            ...
            areaIndex = EditorGUI.Popup(rect, new GUIContent(labelName, "If you are using more than one area in the scene, set different type values for them."), areaIndex, areaNamesGUIContent);
